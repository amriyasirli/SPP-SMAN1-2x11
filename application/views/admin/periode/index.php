              ...
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <a href="<?= base_url('Kelas/add')?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      <tbody>
                        ...
                        ?> 
                            ...
                            <td>
                                <a href="<?= base_url('Kelas/update_view/'.$row->id_kelas)?>" class="btn btn-info btn-sm">Update</a>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <a href="<?= base_url('Kelas/delete/'.$row->id_kelas)?>" class="btn btn-danger">Ok</a>
            </div>
          </div>
        </div>
      </div>